...
class BattlesControllerTest < ActionController::TestCase
  ...
  test "should create battle" do
    assert_difference('Battle.count') do
      post :create, battle: { about: @battle.about, name: @battle.name, round_id: @battle.round_id, tournament_id: @battle.tournament_id }
    end
  ...
  test "should update battle" do
    patch :update, id: @battle, battle: { about: @battle.about, name: @battle.name, round_id: @battle.round_id, tournament_id: @battle.tournament_id }
    assert_redirected_to battle_path(assigns(:battle))
  end
