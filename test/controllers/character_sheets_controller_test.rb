...
class CharacterSheetsControllerTest < ActionController::TestCase
  ...
  test "should create character_sheet" do
    assert_difference('CharacterSheet.count') do
      post :create, character_sheet: { character_id: @character_sheet.character_id, description: @character_sheet.description, sheet: @character_sheet.sheet, title: @character_sheet.title }
    end
  ...
  test "should update character_sheet" do
    patch :update, id: @character_sheet, character_sheet: { character_id: @character_sheet.character_id, description: @character_sheet.description, sheet: @character_sheet.sheet, title: @character_sheet.title }
    assert_redirected_to character_sheet_path(assigns(:character_sheet))
  end
